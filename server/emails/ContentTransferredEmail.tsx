...
export default function ContentTransferredEmailPreview() {
	return (
		<ContentTransferredEmail
			config={{
...
export function ContentTransferredEmail({
	config,
	userName,
	contentName,
	actorName,
	...
	return (
		<Email
			config={config}
			preview={`${actorName} transferred ownership of ${contentName} to you.`}
			heading={`${contentName} has been transferred to you`}
		...
		>
			...
			<Text className="text-gray-700 mt-2">
				{actorName} has transferred ownership of {contentName} to you. You can now view and edit
				this content in iBank. Please review it and make any necessary updates.
			</Text>
			<Button
				href={action}
