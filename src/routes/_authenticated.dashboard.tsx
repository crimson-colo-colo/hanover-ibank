...
import { Alert, Card, Flex, Modal, Paper, SimpleGrid, Text, Title } from "@mantine/core"
import { useDisclosure } from "@mantine/hooks"
import { ContentType } from "@prisma/browser.ts"
import { FileType } from "@shared/filetype.ts"
import type { ContentListItem, listFavoritesType } from "@shared/types.ts"
...
function FavoriteContentModule({
	...
	return (
		<Paper className="mt-4" shadow="xs" p="lg" withBorder>
			<Title order={3} className="mb-4 flex items-center gap-3">
				Your Favorites {favoriteContent.isFetching && <IconLoader2 className="animate-spin" />}
			</Title>
			<SimpleGrid minColWidth="250px" spacing="sm">
