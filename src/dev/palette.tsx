 ...
 * @see https://github.com/JetBrains/react-buddy
 * @author Everett
 * @version 2.0.0 (Mantine v7 compatible)
 */
...
import {
    ...
    Affix,
    // Feedback & Overlays
    Alert, Anchor, AngleSlider,
    // Layout & Structure
    AppShell,
    // Media
    AspectRatio,
    // Data Input
    Autocomplete, Avatar, BackgroundImage, Badge, Blockquote, Box, Breadcrumbs, Burger, Button, Card, Center, Checkbox, Chip, CloseButton, Code, Collapse, ColorInput, ColorPicker, ColorSwatch,
    Combobox, Container, CopyButton, Dialog, Divider, Drawer, Fieldset, FileButton,FileInput, Flex, FloatingIndicator, FloatingWindow, FocusTrap,Grid, Group, Highlight,
    HoverCard, Image, Indicator, Input,InputBase,
    JsonInput, Kbd,
    List, Loader, LoadingOverlay, Mark, Marquee, Menu, Modal, ModalBase,MultiSelect, NativeSelect,
    NavLink,
    Notification, NumberFormatter,NumberInput,
    OverflowList, Overlay, Pagination, Paper, PasswordInput,Pill, PillsInput,
    PinInput, Popover, Portal, Progress, Radio, RangeSlider, Rating, RingProgress,ScrollArea,
    Scroller, SegmentedControl, Select, SemiCircleProgress, SimpleGrid, Skeleton, Slider, Space,Spoiler, Stack, Stepper, Switch, Table, TableOfContents, Tabs, TagsInput,Text, Textarea,
    TextInput, ThemeIcon,Timeline,
    Title, Tooltip,Transition, Tree, Typography,UnstyledButton,VisuallyHidden
} from "@mantine/core";
import {
    Category,
    Component,
...
const noop = () => { throw new Error("Function not implemented."); };
    ...
    <Palette>
        ...
        <Category name="📐 Layout & Structure">
            ...
            <Component name="Container">
                <Variant>
                    <Container size="md" py="xl">Centered content</Container>
                </Variant>
                <Variant name="Fluid">
                    <Container size="100%" px="md">Fluid container</Container>
                </Variant>
            </Component>
        ...
        {/* ========================================================================= */}
        {/* TYPOGRAPHY & CONTENT - Text components and content elements                 */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* FORMS & INPUTS - Form controls and data entry                             */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* BUTTONS & ACTIONS - Clickable elements and actions                        */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* DATA DISPLAY - Tables, trees, structured data                             */}
        {/* ========================================================================= */}
                ...
                <Variant>
                    <Timeline active={1} bulletSize={24} lineWidth={2}>
                        <Timeline.Item bullet={1} title="Order placed">
                            <Text c="dimmed" size="sm">Order #123</Text>
                        </Timeline.Item>
                    </Timeline>
                </Variant>
            </Component>
        ...
        {/* ========================================================================= */}
        {/* FEEDBACK & OVERLAYS - Modals, notifications, loading states                */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* MEDIA & VISUAL - Images, progress, visual elements                         */}
        {/* ========================================================================= */}

        <Category name="🖼️ Media & Visual">
        ...
        {/* ========================================================================= */}
        {/* CARDS & SURFACES - Paper, cards, containers                              */}
        {/* ========================================================================= */}
            ...
            <Component name="Card">
                <Variant>
                    <Card shadow="sm" padding="lg" radius="md" withBorder>
                        ...
                        <Text fw={500} mt="md">Card Title</Text>
        ...
        {/* ========================================================================= */}
        {/* BADGES & LABELS - Status indicators and metadata                          */}
        {/* ========================================================================= */}

        <Category name="🏷️ Badges & Labels">
        ...
        {/* ========================================================================= */}
        {/* NAVIGATION - Links, navigation components                                 */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* AVATAR & USER - User representation                                       */}
        {/* ========================================================================= */}
        ...
        <Category name="👤 Avatar & User">
            <Component name="Avatar">
                ...
                <Variant name="Letters">
                    <Avatar color="cyan" radius="xl">JD</Avatar>
                </Variant>
        ...
        {/* ========================================================================= */}
        {/* UTILITIES & MISC - Helper components                                       */}
        {/* ========================================================================= */}
        ...
        {/* ========================================================================= */}
        {/* BASE COMPONENTS - Low-level building blocks                               */}
        {/* ========================================================================= */}
        ...
        <Category name="🔲 Base Components">
            ...
            <Component name="Box">
                <Variant>
                    <Box p="md" bg="gray.1">Box content</Box>
                </Variant>
            </Component>
        </Category>
    </Palette>
