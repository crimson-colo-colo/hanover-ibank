...
import { Badge, Box, Button, Group, Paper, SegmentedControl, Stack, Text, TextInput, ThemeIcon,} from "@mantine/core";
...
export default function DiscussionPanel({ contentId }: Props) {
    const [threads, setThreads] = useState<Thread[]>(
        mockThreads.filter((thread) => thread.contentId === contentId)
    );
    ...
    const selectedThreadFresh =
        threads.find((thread) => thread.id === selectedThread?.id) ?? null;
                ...
                <Stack gap="xl">
                    <Group justify="space-between" align="flex-start">
                        <Stack gap={8}>
                            ...
                            <Text c="dimmed">
                                Wiki-style discussions for questions, edits, and review notes.
                            </Text>
                        </Stack>
